...
| ----------------- | ------------------ | ------------------    | ----------- |
| [tj-actions/changed-files Action Compromise](2025/tj-actions.md) | 2025 | Publishing Infrastructure | [1](https://www.stepsecurity.io/blog/harden-runner-detection-tj-actions-changed-files-action-is-compromised#recovery-steps) |
